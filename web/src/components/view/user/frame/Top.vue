<template>
    <div class="Top">
      <el-menu
        ...
        <el-menu-item  ><a href="/u/index">首页</a> </el-menu-item>
        <el-menu-item  ><a  href="/h/u/shoppinglist" target="_blank">商品信息</a></el-menu-item>
        ...
        <el-menu-item  ><a href="/user/shop"  target="_blank">购物车</a></el-menu-item>
